def create_model(opt):
    ...
    if opt.model == 'posenet':
        ...
        from .posenet_model import GoogleNetPoseModel
        model=GoogleNetPoseModel()
    ...
    # if opt.init_weights:
    #     print(f"Loading pretrained weights from {opt.init_weights}")
    #     #model.load_network(model.netG, 'G', opt.init_weights)
